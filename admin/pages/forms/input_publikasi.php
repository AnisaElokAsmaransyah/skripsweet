...
session_start();
  ...
  if(isset($_POST['simpan'])){
    $simpan = mysqli_query($koneksi,"INSERT INTO tb_informasi
        (kd_informasi, isi, kategori_informasi ) VALUE
        ('$_POST[kd_informasi]',
        '$_POST[isi]',
        '$_POST[kategori_informasi]' )
    ");
    if($simpan){
        echo "<script>
            ...
            <div class="col-md-4 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <?php
                      $auto = mysqli_query($koneksi, "Select max(kd_informasi) as max_code from tb_informasi");
                    ...
                    ?>
                <form class="forms-sample" action="input_publikasi.php" method="POST">
                  <div class="form-group">
                    <label>Kode Informasi</label>
                    <input type="text" class="form-control " name="kd_informasi" value="<?= $kd_pend?>" readonly>
                  </div>
                  <div class="form-group">
                    <label>Isi</label>
                    <input type="text" class="form-control form-control-lg" name="isi"   placeholder="Silahkan Ketik" >
                  </div>
                  <div class="form-group">
