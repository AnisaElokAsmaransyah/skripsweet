                          ...
                          <div class="modal-dialog">
                            <div class="modal-content">
                              ...
                              <div align = left>
                                      ...
                                      <br>
                                      <?php 
                                      if($data['status'] =="dikirim ke ormas"){ ?>
                                  ...
                                  <span class="response-label">Beri Tanggapan : </span>
                                    ...
                                    if(isset($_POST['tanggapi'])){
                                        ...
                                        // Update status 
                                        $queryUpdate = "UPDATE tb_pengaduan SET status = 'validasi ormas', tanggapan = '$tanggapan', tgl_tanggapan = '$current_time' WHERE kd_pengaduan = '$kd_pengaduan'";
                                        
                                        if ($koneksi->query($queryUpdate) === TRUE) {
                                            echo "<script>
                                                document.location='tanggapi.php';
                                            </script>";
                                            exit();
                                        } else {
